    ...
    <footer id="contact" className="bg-[#0e0c0a] border-t border-white/10 text-white/60 pt-12 pb-8 w-full mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-4 flex flex-col items-center text-center">
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-[#e8a33d] flex items-center justify-center text-stone-900 font-bold text-xl mb-3 shadow-md">
                {cafeConfig.branding.logoLetter}
              </div>
              <h3 className="font-serif text-2xl font-bold text-white uppercase tracking-wider">{cafeConfig.name}</h3>
            </div>
          ...
          <div className="space-y-4 flex flex-col items-center text-center">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <Link to="/order" className="hover:text-white text-[#e8a33d] transition-colors font-medium">Order Online (Delivery & Pickup)</Link>
              </li>
              <li>
                <Link to="/track" className="hover:text-white transition-colors">Track Order Status</Link>
              </li>
              <li>
          ...
          <div className="space-y-4 flex flex-col items-center text-center">
            ...
            <ul className="space-y-3 flex flex-col items-center">
              ...
              <li className="flex flex-col items-center justify-center gap-1.5">
                ...
                <a href={`tel:${cafeConfig.contact.phoneRaw}`} className="text-xs text-white/80 hover:text-[#e8a33d]">
                  {cafeConfig.contact.phone}
                </a>
              </li>
              <li className="flex flex-col items-center justify-center gap-1.5">
                <Mail className="w-4 h-4 text-[#e8a33d] flex-shrink-0" />
                <a href={`mailto:${cafeConfig.contact.email}`} className="text-xs text-white/80 hover:text-[#e8a33d]">
          ...
          <div className="space-y-4 flex flex-col items-center text-center">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-3 text-xs space-y-1">
              <div className="flex flex-col items-center justify-center text-white font-medium gap-1">
                <span>{cafeConfig.timings.daysOpen}</span>
                <span className="text-[#e8a33d]">{cafeConfig.timings.openingHours}</span>
              </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-[10px] uppercase tracking-widest text-white/40">
          <p>&copy; {new Date().getFullYear()} {cafeConfig.name}. All rights reserved.</p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link to="/" className="hover:text-white transition-colors">Home</Link>
            <Link to="/order" className="hover:text-[#e8a33d] transition-colors">Order Online</Link>
